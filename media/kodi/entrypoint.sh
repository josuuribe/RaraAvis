...
start_kodi () {
  ...
  sudo ln -sf /opt/vc/lib/libbcm_host.so /usr/lib/libbcm_host.so.0
  sudo ln -sf /opt/vc/lib/libvchiq_arm.so /usr/lib/libvchiq_arm.so.0
  sudo ln -sf /opt/vc/lib/libvcos.so /usr/lib/libvcos.so.0
