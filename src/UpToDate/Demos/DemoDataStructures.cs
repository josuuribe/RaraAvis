...
internal class DemoDataStructures
{
    public static async Task Execute()
    {
        ...
        PersonRecord personRecord2 = personRecord1 with { };
        if (personRecord1 == personRecord2)
            Console.WriteLine("Equals");
        else
            Console.WriteLine("Not equals");

        dynamic personRecordCopy = new PersonRecord(personRecord1);
        ...
        Student student1 = student with { Level = 4 };
        if (student.Equals(student1))
            Console.WriteLine($"Equals: {student1.ToString()}");
        else
            Console.WriteLine($"Not Equals: {student1.ToString()}");
